    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length:>0})
            {
                ...
                _rabbitMQPublisher.Publish(new ProductImageCreatedEvent() { ImageName = randomImage });
                product.PitcureUrl = randomImage;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Stock,PitcureUrl")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
